...
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON discussions;
...
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON discussion_participants;
