...
import { Plus, MessageSquare, LogOut, Clock, AlertCircle, Users, Shield, CheckCircle, Archive, Briefcase } from 'lucide-react';
...
export const Dashboard = ({ onCreateDiscussion, onViewDiscussion, onViewResults, onAdminPanel, onDepartmentManagement }: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900">DasKann</h1>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-600">{user?.name}</span>
              {isSuperAdmin && onDepartmentManagement && (
                <button
                  onClick={onDepartmentManagement}
                  className="flex items-center space-x-2 px-3 py-1.5 text-sm bg-green-600 text-white rounded hover:bg-green-700 transition"
              ...
              {isAdmin && onAdminPanel && (
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-1.5 text-sm bg-blue-600 text-white rounded hover:bg-blue-700 transition"
                  title="Admin Panel"
                >
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500">
                    <div className="flex items-center space-x-4">
                      ...
                      {discussion.deadline_at && discussion.status !== 'closed' && (
                        <div className="flex items-center space-x-1">
                          <Clock className="w-4 h-4" />
